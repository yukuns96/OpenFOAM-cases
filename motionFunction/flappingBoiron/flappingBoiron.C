...
{
    defineTypeNameAndDebug(flappingBoiron, 0);
...
Foam::solidBodyMotionFunctions::flappingBoiron::
flappingBoiron
(
...
bool Foam::solidBodyMotionFunctions::flappingBoiron::read
(
    const dictionary& SBMFCoeffs
)
{
